...
import { sampleActiveCourses } from "../../../data/sampleActiveCourses";
...
const ActiveCourseList = () => {
  ...
  const allVisible = visible >= sampleActiveCourses.length;
  ...
  return (
    <div className="bg-gray-50 px-8 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {sampleActiveCourses.slice(0, visible).map((course) => (
