...
const CourseDetails = () => {
  ...
  const activeModule = course.modules.find((m) => m.id === Number(moduleId));
            ...
            <div className="space-y-4">
              {activeModule.lessons.map((lesson) => (
                ...
                >
                  ...
                  {/* YELLOW BUTTON (NOT TEXT LINK) */}
                  <Link
                    to={
                      lesson.type === "quiz"
                        ? `/student-course/${course.id}/${activeModule.id}/${lesson.id}/quiz`
                        : `/student-course/${course.id}/${activeModule.id}/${lesson.id}/learn`
                    }
                    className="
