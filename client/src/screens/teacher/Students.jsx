...
//     // Navigate to the student profile page with the student's ID
//     window.location.href = `/teacher/students/${student._id}`;
//   } 
...
//                           <FiExternalLink className="text-gray-400 hover:text-yellow-500 cursor-pointer transition" />
